...
var (
	...
	AdenineGenesisHash  = common.HexToHash("0xa730c03699fd4f86e6a89295b67bf53c51727bc04b362e0cbb8bf6d95d57c293")
	CytosineGenesisHash = common.HexToHash("0x0add092afe4659199c1e7cd7e3a645abe3c1b278017ba2697caf9ad1dacf95fb")
...
var (
	// GeneChainConfig is the chain parameters to run a node on the main network.
	GeneChainConfig = &ChainConfig{
		ChainID:             big.NewInt(80),
	...
	// AdenineChainConfig contains the chain parameters to run a node on the gene test network.
	AdenineChainConfig = &ChainConfig{
	...
	AllEthashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, new(EthashConfig), nil, nil}
	...
	AllRiboseProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, nil, nil, &RiboseConfig{Period: 0, Epoch: 30000}}
...
type ChainConfig struct {
	...
	Ribose *RiboseConfig `json:"ribose,omitempty"`
}

type RiboseConfig struct {
	Period uint64 `json:"period"` // Number of seconds between blocks to enforce
	Epoch  uint64 `json:"epoch"`  // Epoch length to reset votes and checkpoint
}

// String implements the stringer interface, returning the consensus engine details.
func (c *RiboseConfig) String() string {
	return "ribose"
}
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Constantinople: %v Petersburg: %v Istanbul: %v, Muir Glacier: %v, Berlin: %v, YOLO v3: %v, Abies: %v, Bellis: %v, Engine: %v}",
		c.ChainID,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
// IsAbies returns whether num represents a block number after the Abies fork
func (c *ChainConfig) IsAbies(num *big.Int) bool {
	return isForked(c.AbiesBlock, num)
}
